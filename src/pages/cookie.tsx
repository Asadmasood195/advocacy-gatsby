                ...
                <div className="col-md-12">
                  ...
                  <ul className="text-muted">
                    ...
                    <li>
                      ...
                      that is responsible for your information under this Cookie
                      Policy.
                    </li>
                    <li>
                  ...
                  <h3 className="text-muted">Introduction</h3>
                  <p className="text-muted">
                    This Cookie Policy explains how Advocacy.biz by Capitol
                    Enquiry and its affiliates (collectively "Advocacy.biz by
                    Capitol Enquiry", "we", "us", and "ours"), use cookies and
                    similar technologies to recognize you when you visit our
                    website, including without limitation
                    https://www.advocacy.biz and any related URLs, mobile or
                    localized versions and related domains / sub-domains
                    ("Websites"). It explains what these technologies are and
                    why we use them, as well as the choices for how to control
                    them.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">What is a cookie?</h3>
                  <p className="text-muted">
                    A cookie is a small text file that is stored on your
                    computer or other internet connected device in order to
                    identify your browser, provide analytics, remember
                    information about you such as your language preference or
                    login information. They're completely safe and can't be used
                    to run programs or deliver viruses to your device.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Why do we use cookies?</h3>
                  <p className="text-muted">
                    We use first party and/or third party cookies on our website
                  ...
                  <ul className="text-muted">
                    ...
                    <li>
                      To improve your experience of our website and make
                    ...
                    <li>
                      To analyze how our website is used and how best we can
                      customize it;
                    </li>
                    <li>
                  ...
                  <h3 className="text-muted">
                    What type of cookies does Advocacy.biz by Capitol Enquiry
                    use?
                  </h3>
                  <p className="text-muted">
                    Cookies can either be session cookies or persistent cookies.
                    A session cookie expires automatically when you close your
                    browser. A persistent cookie will remain until it expires or
                    you delete your cookies. Expiration dates are set in the
                    cookies themselves; some may expire after a few minutes
                    while others may expire after multiple years. Cookies placed
                    by the website you’re visiting are called “first party
                    cookies”.
                  </p>
                  <p className="text-muted">
                    ...
                    website and use its features. If you remove or disable these
                    cookies, we cannot guarantee that you will be able to use
                    our website.
                  </p>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Essential Cookies</h3>
                  <p className="text-muted">
                    We use essential cookies to make our website work. These
                    cookies are strictly necessary to enable core functionality
                    such as security, network management, your cookie
                    preferences and accessibility. Without them you wouldn't be
                    able to use basic services. You may disable these by
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Marketing Cookies</h3>
                  <p className="text-muted">
                    These account-based marketing cookies enable us to identify
                    future prospects and personalize sales and marketing
                  ...
                  <p className="text-muted">
                    ...
                    understand how our website is being used or how effective
                  ...
                  <p className="text-muted">
                    ...
                    understand your use of our website. Further information on
                    how Google collects and uses this data can be found
                    at: https://www.google.com/policies/privacy/partners/. You
                    can opt-out of all Google supported analytics on our
                    Websites by
                    visiting: https://tools.google.com/dlpage/gaoptout.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Social Media Cookies</h3>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Third Party Cookies</h3>
                  <p className="text-muted">
                    Some cookies that have been set on our website are not set
                    on a first party basis by Advocacy.biz by Capitol Enquiry.
                    The Websites can be embedded with content from third parties
                    to serve advertising. These third party service providers
                    may set their own cookies on your web browser. Third party
                    service providers control many of the performance and
                    functionality, advertising, marketing and analytics cookies
                    described above. We do not control the use of these third
                    party cookies as cookies can only be accessed by the third
                    party that originally set them.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">How you can manage cookies?</h3>
                  <p className="text-muted">
                    ...
                    It may also stop you from saving customized settings like
                    login information. Browser manufacturers provide help pages
                    relating to cookie management in their products.
                  </p>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Changes To Our Cookie Policy</h3>
                  <p className="text-muted">
                    We may change our Service and policies, and we may need to
                    make changes to this Cookie Policy so that they accurately
                    reflect our Service and policies. Unless otherwise required
                    by law, we will notify you (for example, through our
                    Service) before we make changes to this Cookie Policy and
                    give you an opportunity to review them before they go into
                    effect. Then, if you continue to use the Service, you will
                    be bound by the updated Cookie Policy. If you do not want to
                    agree to this or any updated Cookie Policy, you can delete
                    your account.
                  </p>
                  ...
                  <p className="text-muted">
                    ...
                    purchase, you hereby consent to our Cookie Policy and agree
                    to its terms.
                  </p>
