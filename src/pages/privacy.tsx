              ...
              <div className="row">
                <div className="col-md-12">
                  <p className="text-muted">
                    Advocacy.biz by Capitol Enquiry (“we,” “our,” or “us”) is
                    committed to protecting your privacy. This Privacy Policy
                    explains how your personal information is collected, used,
                    and disclosed by Advocacy.biz by Capitol Enquiry.
                  </p>
                  <p className="text-muted">
                    This Privacy Policy applies to our website, and its
                    associated subdomains (collectively, our “Service”)
                    alongside our application, Advocacy.biz by Capitol Enquiry.
                  ...
                  <ul className="text-muted">
                    ...
                    <li>
                      Country: where Advocacy.biz by Capitol Enquiry or the
                      owners/founders of Advocacy.biz by Capitol Enquiry are
                    ...
                    <li>
                      ...
                      Advocacy.biz by Capitol Enquiry or are under contract to
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">What Information Do We Collect?</h3>
                  <p className="text-muted">
                  ...
                  <ul className="text-muted">
                    <li>
                      ...
                      bring more targeted and relevant ads to potential
                      customers.
                    </li>
                    <li>
                      Phonebook (Contacts list): Your contacts list allows the
                      to be much more easy to use by the user, since accessing
                      your contacts from the app makes you save tons of time.
                    </li>
                  </ul>
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">
                    When does Advocacy.biz by Capitol Enquiry use end user
                    information from third parties?
                  </h3>
                  <p className="text-muted">
                    Advocacy.biz by Capitol Enquiry will collect End User Data
                    necessary to provide the Advocacy.biz by Capitol Enquiry
                    services to our customers. End users may voluntarily provide
                    us with information they have made available on social media
                    websites. If you provide us with any such information, we
                    may collect publicly available information from the social
                    media websites you have indicated. You can control how much
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">
                    When does Advocacy.biz by Capitol Enquiry use customer
                    information from third parties?
                  </h3>
                  <p className="text-muted">
                    We receive some information from the third parties when you
                    contact us. For example, when you submit your email address
                    to us to show interest in becoming a Advocacy.biz by Capitol
                    Enquiry customer, we receive information from a third party
                    that provides automated fraud detection services to
                    Advocacy.biz by Capitol Enquiry. We also occasionally
                    collect information that is made publicly available on
                    social media websites. You can control how much of your
                    information social media websites make public by visiting
                  ...
                  <p className="text-muted">
                    ...
                    through the website. We will likely share your personal
                  ...
                  <p className="text-muted">
                    ...
                    website. They may aggregate information about our
                  ...
                  <p className="text-muted">
                    Advocacy.biz by Capitol Enquiry will collect personal
                    information that you submit to us. We may also receive
                    personal information about you from third parties as
                    described above.
                  </p>
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">How Do We Use Your Email Address?</h3>
                  <p className="text-muted">
                    By submitting your email address on this website, you agree
                  ...
                  <p className="text-muted">
                    ...
                    provide Advocacy.biz by Capitol Enquiry to you and fulfill
                    the purposes described in this policy. This is also the case
                    for anyone that we share your information with and who
                    carries out services on our behalf. When we no longer need
                    to use your information and there is no need for us to keep
                  ...
                  <p className="text-muted">
                    ...
                    security of any information you transmit to Advocacy.biz by
                    Capitol Enquiry or guarantee that your information on the
                  ...
                  <p className="text-muted">
                    Advocacy.biz by Capitol Enquiry is incorporated in United
                    States. Information collected via our website, through
                    direct interactions with you, or from use of our help
                    services may be transferred from time to time to our offices
                    or personnel, or to third parties, located throughout the
                    ...
                    To the fullest extent allowed by applicable law, by using
                    any of the above, you voluntarily consent to the
                    trans-border transfer and hosting of such information.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">
                    Is the information collected through the Advocacy.biz by
                    Capitol Enquiry Service secure?
                  </h3>
                  <p className="text-muted">
                  ...
                  <p className="text-muted">
                    ...
                    information Advocacy.biz by Capitol Enquiry collects depend
                    on your relationship with Advocacy.biz by Capitol Enquiry.
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Personnel</h3>
                  <p className="text-muted">
                    If you are a Advocacy.biz by Capitol Enquiry worker or
                    applicant, we collect information you voluntarily provide to
                    us. We use the information collected for Human Resources
                    purposes in order to administer benefits to workers and
                    screen applicants.
                  </p>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Sale of Business</h3>
                  <p className="text-muted">
                    We reserve the right to transfer information to a third
                    party in the event of a sale, merger or other transfer of
                    all or substantially all of the assets of Advocacy.biz by
                    Capitol Enquiry or any of its Corporate Affiliates (as
                    defined herein), or that portion of Advocacy.biz by Capitol
                    Enquiry or any of its Corporate Affiliates to which the
                    ...
                    proceeding, provided that the third party agrees to adhere
                    to the terms of this Privacy Policy.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Affiliates</h3>
                  <p className="text-muted">
                    ...
                    by or is under common control with Advocacy.biz by Capitol
                    Enquiry, whether by ownership or otherwise. Any information
                    relating to you that we provide to our Corporate Affiliates
                    will be treated by those Corporate Affiliates in accordance
                    with the terms of this Privacy Policy.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Governing Law</h3>
                  <p className="text-muted">
                  ...
                  <p className="text-muted">
                    By using Advocacy.biz by Capitol Enquiry or contacting us
                    directly, you signify your acceptance of this Privacy
                    Policy. If you do not agree to this Privacy Policy, you
                    should not engage with our website, or use our services.
                  ...
                  <p className="text-muted">
                    ...
                    our site and how it's being used. By using our Advocacy.biz
                    by Capitol Enquiry, registering an account, or making a
                    purchase, you hereby consent to our Privacy Policy and agree
                    to its terms.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Links to Other Websites</h3>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Cookies</h3>
                  <p className="text-muted">
                    Advocacy.biz by Capitol Enquiry uses "Cookies" to identify
                    the areas of our website that you have visited. A Cookie is
                    a small piece of data stored on your computer or mobile
                    device by your web browser. We use Cookies to enhance the
                    performance and functionality of our website but are
                    non-essential to their use. However, without these cookies,
                    certain functionality like videos may become unavailable or
                    you would be required to enter your login details every time
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Remarketing Services</h3>
                  <p className="text-muted">
                    ...
                    they're “following” people around the internet by serving
                    ads on the websites and platforms they use most.
                  </p>

                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Payment Details</h3>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Kids' Privacy</h3>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Changes To Our Privacy Policy</h3>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Third-Party Services</h3>
                  <p className="text-muted">
                  ...
                  <p className="text-muted">
                    You acknowledge and agree that Advocacy.biz by Capitol
                    Enquiry shall not be responsible for any Third-Party
                    Services, including their accuracy, completeness,
                    timeliness, validity, copyright compliance, legality,
                    decency, quality or any other aspect thereof. Advocacy.biz
                    by Capitol Enquiry does not assume and shall not have any
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Facebook Pixel</h3>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Tracking Technologies</h3>
                  <h3 className="text-muted"></h3>
                  <ul>
                      ...
                      <ul>
                        <li>
                          ...
                          <p className="text-muted">
                            ...
                            functionality of our but are non-essential to their
                            use. However, without these cookies, certain
                            functionality like videos may become unavailable or
                            you would be required to enter your login details
                            every time you visit the as we would not be able to
                      ...
                      <ul>
                        <li>
                          ...
                          <p className="text-muted">
                            ...
                            that you have visited. A Session is a small piece of
                            data stored on your computer or mobile device by
                            your web browser.
                          </p>
                        </li>
                      </ul>
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">What is GDPR?</h3>
                  <p className="text-muted">
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">Why is GDPR important?</h3>
                  <p className="text-muted">
                    ...
                    do. At Advocacy.biz by Capitol Enquiry we strongly believe
                    that your data privacy is very important and we already have
                    solid security and privacy practices in place that go beyond
                  ...
                  <p className="text-muted">
                    ...
                    subject rights requirements of GDPR. Advocacy.biz by Capitol
                    Enquiry processes or stores all personal data in fully
                    vetted, DPA compliant vendors. We do store all conversation
                    and personal data for up to 6 years unless your account is
                    deleted. In which case, we dispose of all data in accordance
                    with our Terms of Service and Privacy Policy, but we will
                  ...
                  <h3 className="text-muted"></h3>
                  <h3 className="text-muted">California Residents</h3>
                  <p className="text-muted">
